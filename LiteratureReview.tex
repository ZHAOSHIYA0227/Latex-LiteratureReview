...
\title{\bf \huge Literature review \\
 \large Household Energy Use Modeling-- A summary on the methodology}
\author{Shiya ZHAO}
...
\part{Econometric Models}
\input{./chapter/1_EconometricModels.tex}
% \input{./chapter/complexity.tex}

\part{Demand Systems}
\input{./chapter/2_DemandSystems.tex}
